...
DATABASES = {
    'default': {
        ...
        'HOST': 'clarusway.cckaqahn4jix.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones-abdu-blog' # please enter your s3 bucket name
